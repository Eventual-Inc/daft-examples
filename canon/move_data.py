...
subsets = {
    "general_visual_qna": ["vqav2", "cocoqa", "visual7w", "aokvqa", "tallyqa", "okvqa", "hateful_memes", "vqarad"],
    "captioning": ["localized_narratives", "screen2words", "vsr"],
    "ocr_doc_understanding": ["rendered_text", "docvqa", "textcaps", "textvqa", "st_vqa", "ocrvqa", "visualmrc", "iam", "infographic_vqa", "diagram_image_to_text"],
    "chart_figure_understanding": ["chart2text", "dvqa", "vistext", "chartqa", "plotqa", "figureqa", "mapqa"],
    "table_understanding": ["tabmwp", "tat_qa", "hitab", "multihiertt", "finqa", "robut_wikisql", "robut_sqa", "robut_wtq"],
    "reasoning_logic_maths": ["geomverse", "clevr_math", "clevr", "iconqa", "raven", "intergps"],
