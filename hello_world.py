...
def example():
    data = daft.from_pydict(
        {
            "content": [
                "Einstein was a brilliant scientist.Shakespeare was a brilliant writer",
    ...
    data = data.with_column("embedding", embed_text(text=data["content"], model="Qwen/Qwen3-Embedding-0.6B"))
    return data
