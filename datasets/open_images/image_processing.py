...
df_resized = df.with_column(
    "resized", image_resize(col("image"), width=224, height=224)
)
...
df_high_res = df.with_column(
    "high_res", image_resize(col("image"), width=512, height=512)
)
